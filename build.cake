...
var projects = new []
{
    System.IO.Path.Combine(sourceDir, "PreAnnouncement.Lambda/PreAnnouncement.Lambda.csproj")
};
...
Task("Publish")
    ...
    .Does(() => 
    {
        foreach(var project in projects)
        {
            ...
            Information("Publishing '{0}' at {1}...", projectName, project);
...
Task("AwsCliPackage")
	...
	.Does(() =>
    {
        ...
        {
            Arguments = $"cloudformation package --template-file ./cloud/cloudformation.yaml --s3-bucket {samArtifactsBucket} --output-template-file packaged.yaml",
        };
